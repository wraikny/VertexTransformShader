...
namespace VertexTransformShaders
{
    public class CubedParadoxFlatLitToonInspector : ShaderGUI
    {
        ...
        MaterialProperty objectPosition;
        MaterialProperty objectRotation;
        MaterialProperty objectScale;
        MaterialProperty worldPosition;
        ...
        {
            { //Find Properties
                objectPosition = FindProperty("_VertObjectPosition", props);
                objectRotation = FindProperty("_VertObjectRotation", props);
                objectScale = FindProperty("_VertObjectScale", props);
                worldPosition = FindProperty("_VertWorldPosDiff", props);
            ...
            { //Shader Properties GUI
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    materialEditor.VectorProperty(objectPosition, "Object Position");
                    materialEditor.VectorProperty(objectRotation, "Object Rotation");
                    materialEditor.VectorProperty(objectScale, "Object Scale");
                    materialEditor.VectorProperty(worldPosition, "World Position Difference");
